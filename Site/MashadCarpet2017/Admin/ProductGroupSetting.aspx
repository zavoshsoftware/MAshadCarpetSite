<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ProductGroupSetting.aspx.cs" Inherits="MashadCarpet.Admin.ProductGroupSetting" %>
           ...
           <asp:GridView ID="grdTable" runat="server" AutoGenerateColumns="False" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowCommand="grdProductGroup_RowCommand">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="EN_ProductGroupTitle" HeaderText="عنوان انگلیسی" />
                       <asp:BoundField DataField="Rus_ProductGroupTitle" HeaderText="عنوان روسی" />
                       <asp:BoundField DataField="China_ProductGroupTitle" HeaderText="عنوان چینی" />
                    ...
                    <asp:TemplateField HeaderText="تنظیمات">
                        <ItemTemplate>
                            ...
                            <asp:LinkButton ID="lbEdit" runat="server" CommandArgument='<%# Eval("ProductGroupID") %>' CommandName="DoEdit" CssClass="lb">ویرایش</asp:LinkButton>
                              <br />
                             <i class="fa fa-edit"></i>
                            <asp:LinkButton ID="lbPages" runat="server" CommandArgument='<%# Eval("ProductGroupID") %>' CommandName="ShowProducts" CssClass="lb">محصولات</asp:LinkButton>
                            <br />
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <dfn style="color: #4C8BF5;">در نام سیستمی از space و & استفاده نکنید.</dfn>
