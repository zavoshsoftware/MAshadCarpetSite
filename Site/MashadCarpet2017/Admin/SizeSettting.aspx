<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="SizeSettting.aspx.cs" Inherits="MashadCarpet.Admin.SizeSettting" %>
     ...
     <asp:MultiView ID="mvSetting" runat="server">
        <asp:View ID="vwList" runat="server">
            ...
            <asp:GridView ID="grdTable" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowCommand="grdTable_RowCommand" Width="100%">
                ...
                <Columns>
                        <asp:BoundField DataField="SizeID" HeaderText="کد سایز" />

                    <asp:BoundField DataField="SizeTitle" HeaderText="عنوان" />

                
                    <%--<asp:BoundField DataField="SizeName" HeaderText="عنوان سیستمی" />--%>
                    ...
                    <asp:TemplateField HeaderText="توضیحات">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:LinkButton ID="lbEdit" runat="server" CommandArgument='<%# Eval("SizeID") %>' CommandName="DoEdit" CssClass="lb">ویرایش</asp:LinkButton>
                            <br />
                            <i class="fa fa-times"></i>
                            <asp:LinkButton ID="lbDelete" runat="server" CommandArgument='<%# Eval("SizeID") %>' CommandName="DoDelete" CssClass="lb">حذف</asp:LinkButton>
                            <br />
                        </ItemTemplate>
